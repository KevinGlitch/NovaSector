...
/obj/structure/sign/arcanum
	name = "\improper Arcanum logo sign"
	sign_change_name = "Corporate Logo - Arcanum Research Corporation"
	desc = "A sign with the ARC logo on it."
	icon_state = "arcanum"
	is_editable = TRUE
